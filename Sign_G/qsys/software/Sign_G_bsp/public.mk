...
SOPCINFO_FILE := D:/Ruanjian/Quartus15.0/Test/Shouyu/Sign_G/qsys/hardware/DE10_NANO_qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1048
SOPC_SYSID_FLAG += --sidp=0x1048
ELF_PATCH_FLAG  += --sidp 0x1048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1637742172
SOPC_SYSID_FLAG += --timestamp=1637742172
ELF_PATCH_FLAG  += --timestamp 1637742172
